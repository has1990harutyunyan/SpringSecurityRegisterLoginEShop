                ...
                <div class="product-details"><!--product-details-->
                    ...
                    <div class="col-sm-5">
                        <div class="view-product">
                            <img src="/getImage?imageName=${product.mainPic}" alt=""/>
                            <h3>ZOOM</h3>
                        </div>
                    </div>
                    <div class="col-sm-7">
                        ...
                        <div class="product-information"><!--/product-information-->
                            ...
                            <h2>${product.brand.name} ${product.sleeveType} ${product.colour} ${product.clothingType} </h2>
                            <p>Web ID: 1089772</p>
                            ...
                            <a href=""><img src="/img/share.png" class="share img-responsive" alt=""/></a>
                        ...
                        <div class="tab-pane fade active in" id="reviews">
                            <div class="col-sm-12">
                                ...
                                <form action="#">
                                    ...
                                    <b>Rating: </b> <img src="/img/rating.png" alt=""/>
                    ...
                    <div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="item active">
                                <c:forEach items="${productListNotLikeId}" var="productExcId">
                                    <div class="col-sm-4">
                                        <div class="product-image-wrapper">
                                            <div class="single-products">

                                                <div class="productinfo text-center">
                                                    <img src="/getImage?imageName=${productExcId.mainPic}" alt=""/>
                                                    <h2>${productExcId.currency} ${productExcId.cost}</h2>
                                                    <p>${productExcId.brand.name} ${productExcId.colour} ${productExcId.clothingType} </p>
                                                    <button type="button" class="btn btn-default add-to-cart"><i
                                                            class="fa fa-shopping-cart"></i>Add to cart
                                                    </button>
                                                </div>
